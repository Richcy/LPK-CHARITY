...
$jenis_kursus = $pecah['jenis_kursus'];
...
$koneksi->query("INSERT INTO murid(username_murid,nik_murid,jadwal_murid,jenis_kursus,tempat_lahir_murid,tanggal_lahir_murid,jenis_kelamin_murid,alamat_murid,email_murid,no_hp_murid,status_murid) VALUES('$username','$nik','$jadwal','$jenis_kursus','$tempat_lahir','$tanggal_lahir','$jk','$alamat','$email','$hp','$status')");
